文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\LoginController::secondVerifySend

## 接口：二次验证发送验证码

接口地址：login/second\_verify\_send POST

二次验证发送验证码 -- wyh

  

**接口说明:二次验证发送验证码,登录调用此方法**
