文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\LoginController::getSecondVerifyPage

## 接口：二次验证页面

接口地址：login/second\_verify\_page GET

二次验证页面 -- wyh

  

**接口说明:二次验证页面,此接口登录验证使用**
