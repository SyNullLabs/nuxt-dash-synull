文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CreditLimitController::update

## 接口：修改信用额

接口地址：/admin/credit\_limit put
