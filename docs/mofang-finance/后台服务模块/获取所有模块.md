文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ProvisionController::getModules

## 接口：获取所有模块

接口地址： admin/provision/list GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".value":"值",       ".name":"显示的名称",     }   }`
