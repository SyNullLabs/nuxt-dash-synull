文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketDeliverController::addPage

## 接口：添加新规则页面

接口地址： admin/get\_ticket\_deliver GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "id":"部门id",       "name":"部门名称",     }   }`
