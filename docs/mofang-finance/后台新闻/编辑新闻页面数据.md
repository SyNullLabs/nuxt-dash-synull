文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\NewsController::getContent

## 接口：编辑新闻页面数据

接口地址：/admin/news/content GET

编辑新闻页面数据 -- 萧十一郎

  

**接口说明:新闻页面数据，传递id时返回文章，和组数据**
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "new_content":"新闻数据",       "cat_data":"分类数据",     }   }`
