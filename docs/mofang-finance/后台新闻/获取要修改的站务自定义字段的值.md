文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\NewsController::getGetCustomUpdateVal

## 接口：获取要修改的站务自定义字段的值

接口地址：/admin/news/getCustomUpdateVal GET

获取要修改的站务自定义字段的值 -- xue

  

**接口说明:获取要修改的站务自定义字段的值**
