文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SetController::delCustomFields

## 接口：删除用户自定义字段配置

接口地址：/admin/del\_custom\_fields post
...
删除的自定义字段类型(client:用户，product：产品，ticket:工单，)
