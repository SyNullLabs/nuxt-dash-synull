文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SaleController::saleUsers

## 接口：销售管理统计页 销售列表

接口地址：/admin/sale/sale\_users GET

销售管理统计页 销售列表 -- 请设置auhtor注释
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "list":[{//销售列表         "user_nickname":"昵称",         "id":"id",       }]     }   }`
