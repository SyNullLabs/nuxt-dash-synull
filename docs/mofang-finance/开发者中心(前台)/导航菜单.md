文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DeveloperController::getnavlist

## 接口：导航菜单

接口地址：/developer/navlist GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//导航列表       }]     }   }`
