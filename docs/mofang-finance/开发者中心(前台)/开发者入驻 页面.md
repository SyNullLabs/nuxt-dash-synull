文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DeveloperController::getDeveloper

## 接口：开发者入驻 页面

接口地址：/developer/developer GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".certif":"是否实名认证：0 未认证,1 已认证",       ".phone":"是否手机绑定",       ".developer":[{//开发者信息       }]     }   }`
