文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DeveloperController::deleteDeveloperRewardSignUp

## 接口：悬赏取消报名

接口地址：/developer/developerrewardsignup DELETE
