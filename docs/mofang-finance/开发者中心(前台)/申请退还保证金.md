文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DeveloperController::deleteDeveloperRewardReturn

## 接口：申请退还保证金

接口地址：/developer/developerrewardreturn DELETE
