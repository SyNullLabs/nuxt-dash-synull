文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\UpgradeController::removePromoCodeFromConfig

## 接口：升降级产品可配置项--移除优惠码

接口地址：/upgrade/remove\_promo\_code POST

升降级产品可配置项--移除优惠码 -- wyh

  

**接口说明:升降级产品可配置项--移除优惠码**
