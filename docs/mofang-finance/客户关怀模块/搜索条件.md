文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ClientCareController::searchCondition

## 接口：搜索条件

接口地址：/admin/client\_care/search\_condition GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".trigger":"搜索条件",     }   }`
