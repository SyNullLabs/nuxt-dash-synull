文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\MarketPublicController::knowledgeView

## 接口：付费知识查看

接口地址：/market/knowledge/:id/view get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "status":"状态0未成功付费1成功付费",       "invoice_id":"现金账单ID",     }   }`
