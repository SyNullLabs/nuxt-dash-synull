文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\KnowledgeBaseController::addArticle
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".aid":"文章ID",     }   }`
