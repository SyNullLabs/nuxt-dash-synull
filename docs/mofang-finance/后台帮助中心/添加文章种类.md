文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\KnowledgeBaseController::addCategory

## 接口：添加文章种类

接口地址：/admin/knowledge\_base/add\_category POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".cid":"种类ID",     }   }`
