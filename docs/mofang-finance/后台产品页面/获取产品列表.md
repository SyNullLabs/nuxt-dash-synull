文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ClientsServicesController::getProductList

## 接口：获取产品列表

接口地址：/admin/clients\_services/get\_product\_list get
