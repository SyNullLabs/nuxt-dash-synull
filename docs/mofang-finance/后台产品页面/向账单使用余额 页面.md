文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ClientsServicesController::getApplyCreditPage

## 接口：向账单使用余额 页面

接口地址：/admin/clients\_services/apply\_credit\_page POST
