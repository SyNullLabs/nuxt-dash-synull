文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::postApiConfig

## 接口：魔方财务资源api设置页面

接口地址：/admin/config\_general/apiconfig POST
