文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::getHeader

## 接口：头部底部

接口地址：/admin/config\_general/header GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "header":"头部",       "footer":"底部",     }   }`
