文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::postGetConfigOption

## 接口：系统设置选项统一获取接口（新）

接口地址：/admin/config\_general/getConfigOption post
