文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::setAdminLang

## 接口：设置后台系统语言(cookie设置)

接口地址：/admin/config\_general/set\_admin\_lang POST

设置后台系统语言(cookie设置) -- wyh
