文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::postLoginErrorMax

## 接口：修改最大错误次数

接口地址：/admin/config\_general/loginErrorMax post
