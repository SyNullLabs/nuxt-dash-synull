文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::registerLoginPage

## 接口：注册登录--页面

接口地址：/admin/config\_general/register\_login\_page get
