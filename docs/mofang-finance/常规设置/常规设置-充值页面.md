文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::getRecharge

## 接口：常规设置-充值页面

接口地址：/admin/config\_general/recharge GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "addfunds_enabled":"1.客户可以在用户中心添加余额至账户中",     }   }`
