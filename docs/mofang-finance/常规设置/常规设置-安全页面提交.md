文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::postSafe

## 接口：常规设置-安全页面提交

接口地址：/admin/config\_general/safe POST
