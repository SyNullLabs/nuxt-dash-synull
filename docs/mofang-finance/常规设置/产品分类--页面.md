文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::productgroupPage

## 接口：产品分类--页面

接口地址：/admin/config\_general/productgroup\_page get
