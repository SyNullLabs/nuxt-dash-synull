文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::productgroupList

## 接口：产品分类--列表

接口地址：/admin/config\_general/productgroup\_list get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "groupname":"产品组菜单名",       "fa_icon":"图标",     }   }`
