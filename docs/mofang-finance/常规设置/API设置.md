文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigGeneralController::getApiConfig

## 接口：API设置

接口地址：/admin/config\_general/apiconfig GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".allow_resource_api":"是否开启资源api",     }   }`
