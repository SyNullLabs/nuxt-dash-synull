文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::detail
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "switch":[{//交换机数据         "switch_id":"连接的交换机ID",         "name":"端口名称",       }]     }   }`
