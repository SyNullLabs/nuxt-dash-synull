文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::getReinstallStatus

## 接口：获取重装,救援系统,重置密码进度

接口地址：/dcim/resintall\_status GET
