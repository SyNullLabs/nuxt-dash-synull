文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::checkReinstall

## 接口：验证是否可以重装

接口地址：/dcim/check\_reinstall POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "num":"本周已重装次数",       "max_times":"最大重装次数(0不限)",       "price":"重装次数价格(返回该参数说明已达上限并且可以购买重装次数)",     }   }`
