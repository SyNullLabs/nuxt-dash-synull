文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::hideLastResult

## 接口：隐藏上次重装/重置密码/救援系统结果

接口地址：/dcim/hide\_result POST

隐藏上次重装/重置密码/救援系统结果 -- huanghao
