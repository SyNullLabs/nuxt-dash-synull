文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::checkAllReinstallStatus

## 接口：获取是否在重装

接口地址：/dcim/check\_all\_status POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "0":[{//列表数据       }]     }   }`
