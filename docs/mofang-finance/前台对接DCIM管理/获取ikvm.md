文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::ikvm
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "name":"下载的文件名",       "token":"验证标识",     }   }`
