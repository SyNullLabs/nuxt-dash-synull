文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DcimController::buyReinstallTimes

## 接口：购买重装次数生成账单

接口地址：/dcim/buy\_reinstall\_times POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "invoiceid":"账单ID",     }   }`
