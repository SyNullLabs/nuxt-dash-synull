文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AgentController::postUpload

## 接口：上传图片

接口地址： admin/agent/upload POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "savename":"上传的文件路径",     }   }`
