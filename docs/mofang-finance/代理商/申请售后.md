文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AgentController::postAfterSale

## 接口：申请售后

接口地址：/admin/agent/aftersale POST
...
申请附件(调上传文件接口admin/agent/upload取返回值savename),拼接成数组
