文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMessageController::testMessageTemplate

## 接口：测试短信模板

接口地址：/admin/config\_message/test\_message\_template POST
