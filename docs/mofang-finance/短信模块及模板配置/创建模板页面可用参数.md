文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMessageController::getTemplateDesc

## 接口：创建模板页面可用参数

接口地址：/admin/config\_message/get\_template\_desc GET
