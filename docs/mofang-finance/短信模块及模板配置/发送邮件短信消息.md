文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMessageController::sendMessagePost1

## 接口：发送邮件短信消息

接口地址：/admin/config\_message/sendmessage\_post POST
