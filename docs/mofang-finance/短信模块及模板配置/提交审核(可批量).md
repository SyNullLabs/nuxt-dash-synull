文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMessageController::checkPost

## 接口：提交审核(可批量)

接口地址：/admin/config\_message/check\_post POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "checkmsg":"提交审核情况",     }   }`
