文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\OauthController::config

## 接口：三方登录接口配置信息

接口地址：/admin/oauth/config GET

三方登录接口配置信息 -- xionglingyuan

  

**接口说明:三方登录接口配置信息，返回在程序中自定义的配置项**
