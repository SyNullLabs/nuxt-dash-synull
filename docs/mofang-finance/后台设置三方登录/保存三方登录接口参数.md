文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\OauthController::configSave

## 接口：保存三方登录接口参数

接口地址：/admin/oauth/config\_post POST

保存三方登录接口参数 -- xionglingyuan
