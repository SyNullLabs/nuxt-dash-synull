文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InterflowSetingController::botCheckStatus

## 接口：检测更新机器账号在线状态

接口地址：/admin/interflow/botCheckStatus POST

检测更新机器账号在线状态 -- 请设置auhtor注释
