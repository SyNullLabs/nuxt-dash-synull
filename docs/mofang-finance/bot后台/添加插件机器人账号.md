文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InterflowSetingController::botAccountPost

## 接口：添加插件机器人账号

接口地址：/admin/interflow/botAccountPost POST

添加插件机器人账号 -- 请设置auhtor注释
