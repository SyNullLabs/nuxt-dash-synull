文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InterflowSetingController::keywordExecuteSwitch

## 接口：执行器开启与关闭

接口地址：/admin/interflow/keywordExecuteSwitch POST

执行器开启与关闭 -- 请设置auhtor注释
