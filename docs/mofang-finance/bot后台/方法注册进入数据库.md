文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InterflowSetingController::funcRegister

## 接口：方法注册进入数据库

接口地址：/admin/interflow/funcRegister POST

方法注册进入数据库 -- 请设置auhtor注释
