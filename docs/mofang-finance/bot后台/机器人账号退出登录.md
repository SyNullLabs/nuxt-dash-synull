文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InterflowSetingController::botAccountLoginOut

## 接口：机器人账号退出登录

接口地址：/admin/interflow/botAccountLoginOut POST

机器人账号退出登录 -- 请设置auhtor注释
