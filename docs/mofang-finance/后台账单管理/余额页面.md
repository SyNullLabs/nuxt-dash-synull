文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InvoiceController::addPayInvoicePage

## 接口：余额页面

接口地址：admin/invoice/add\_pay\_invoice\_page/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".surplus":"结余(默认放在添加付款金额到账单的输入框中)",     }   }`
