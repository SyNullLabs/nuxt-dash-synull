文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InvoiceController::getCombineInvoices

## 接口：合并账单页面

接口地址：/admin/get\_combine\_invoices GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"多少笔未支付",       "total":"总金额",       "invoices":[{//账单数据       }]     }   }`
