文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\InvoiceController::addPayPage

## 接口：新增付款页面

接口地址：admin/invoice/addpay\_page/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "id":"账单ID",       "sruplus":"结余",       "gateway":"支付方式",     }   }`
