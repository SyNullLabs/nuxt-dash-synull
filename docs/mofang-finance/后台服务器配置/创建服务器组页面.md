文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigServersController::createGroups

## 接口：创建服务器组页面

接口地址：/admin/create\_groups GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".data.servers":"接口列表",       ".data.mode":"分配方式",     }   }`
