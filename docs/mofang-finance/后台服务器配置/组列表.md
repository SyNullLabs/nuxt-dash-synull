文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigServersController::groupsList

## 接口：组列表

接口地址：/admin/groups\_list GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".data":"组列表",     }   }`
