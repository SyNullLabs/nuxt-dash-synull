文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigServersController::testLink

## 接口：服务器连接测试

接口地址：admin/server\_test\_link/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".name":"server_status type",       ".name":"msg type",     }   }`
