文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DownController::productFile

## 接口：下载支持文件

接口地址：download/product\_file GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "info":"存在该信息则为用户需要购买相应产品才可下载该文件",     }   }`
