文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\DownController::search

## 接口：返回搜索数据

接口地址：download/search POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "downloads":[{//下载数据         "id":"文件id",         "title":"文件id",         "description":"文件描述",         "downloads":"下载数",         "down_link":"下载链接",       }]     }   }`
