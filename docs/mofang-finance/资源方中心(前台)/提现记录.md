文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getWithdraw

## 接口：提现记录

接口地址：admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=getWithdraw GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "logs":"提现记录",       "count":"数量",     }   }`
