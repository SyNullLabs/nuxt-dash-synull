文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceShopBannerDelete

## 接口：删除店铺banner

接口地址：/resource/resourceshopbannerdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=deleteResourceShopBanner) GET
