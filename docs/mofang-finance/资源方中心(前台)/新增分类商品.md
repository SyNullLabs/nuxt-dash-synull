文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceShopHotGroupProducts

## 接口：新增分类商品

接口地址：/resource/resourceshophotgroupproducts(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceShopHotGroupProducts) POST
