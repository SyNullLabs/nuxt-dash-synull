文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceShopBanner

## 接口：获取店铺banner信息

接口地址：/resource/resourceshopbanner(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=getResourceShopBanner) GET
