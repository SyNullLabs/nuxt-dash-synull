文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceShopBannerSort

## 接口：banner排序修改

接口地址：/resource/resourceshopbannersort(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceShopBannerSort) POST
