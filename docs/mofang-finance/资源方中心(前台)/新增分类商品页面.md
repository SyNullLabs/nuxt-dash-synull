文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceShopHotGroup

## 接口：新增分类商品页面

接口地址：/resource/resourceshophotgroup(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=getResourceShopHotGroup) GET
