文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceTicketOpen

## 接口：工单传递

接口地址：/resource/resourceticketopen(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceTicketOpen) GET
