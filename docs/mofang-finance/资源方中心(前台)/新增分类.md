文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceShopHotGroup

## 接口：新增分类

接口地址：/resource/resourceshophotgroup(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceShopHotGroup) POST
