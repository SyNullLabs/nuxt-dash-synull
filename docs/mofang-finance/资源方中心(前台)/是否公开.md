文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postProductsPublic

## 接口：是否公开

接口地址：/resource/productspublic(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceProductPublic) POST

是否公开 -- wyh

  

**接口说明:是否公开,关闭的状态下只有资源池才能订购**
