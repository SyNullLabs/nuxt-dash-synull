文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getFirstGroupDelete

## 接口：分类删除

接口地址：/resource/firstgroupdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=deleteResourceProductsFirstGroup) GET
