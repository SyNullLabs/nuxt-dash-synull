文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceShopToggle

## 接口：切换店铺

接口地址：/resource/resourceshoptoggle(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceShopToggle) POST
