文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceShopHotGroupDelete

## 接口：删除分类

接口地址：/resource/resourceshophotgroupdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=deleteResourceShopHotGroup) GET
