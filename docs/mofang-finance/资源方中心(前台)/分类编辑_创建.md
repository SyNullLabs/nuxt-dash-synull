文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postFirstGroup

## 接口：分类编辑/创建

接口地址：/resource/firstgroup(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceProductsFirstGroup) POST
