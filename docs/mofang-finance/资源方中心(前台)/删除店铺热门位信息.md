文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceShopHotDelete

## 接口：删除店铺热门位信息

接口地址：/resource/resourceshophotdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=getResourceShopHotDelete) GET
