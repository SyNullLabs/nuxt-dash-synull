文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getResourceSupplierInfo

## 接口：获取供应商基础信息(个人资料)

接口地址：/resource/resourceshophot(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=getResourceSupplierInfo) GET
