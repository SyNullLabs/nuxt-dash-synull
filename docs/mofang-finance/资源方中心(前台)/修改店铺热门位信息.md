文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::postResourceShopHot

## 接口：修改店铺热门位信息

接口地址：/resource/resourceshophot(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=postResourceShopHot) POST
