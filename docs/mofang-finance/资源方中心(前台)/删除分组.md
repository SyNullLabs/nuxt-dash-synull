文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getGroupDelete

## 接口：删除分组

接口地址：/resource/groupdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=deleteResourceProductsGroup) GET
