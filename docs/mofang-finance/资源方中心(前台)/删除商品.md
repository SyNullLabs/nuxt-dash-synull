文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceHomeController::getProductsDelete

## 接口：删除商品

接口地址：/resource/productsdelete(admin/addons?\_plugin=idcsmart\_res\_supplier&\_controller=AdminIndex&\_action=deleteResourceProduct) GET
