文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\CertificationController::ping

## 接口：查询认证是否完成

接口地址：/certifi\_ping get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "status":"400失败，200成功",     }   }`
