文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimController::addFlowPacketPage

## 接口：添加流量包页面

接口地址：/admin/dcim/flowpacket\_page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "products":[{//可用产品         "id":"产品ID",         "name":"产品名称",       }]     }   }`
