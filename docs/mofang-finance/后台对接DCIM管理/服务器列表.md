文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimController::serverList

## 接口：服务器列表

接口地址：/admin/dcim/server GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "list":[{//列表数据         "id":"服务器ID",         "name":"服务器名称",         "hostname":"服务器地址",         "server_num":"服务器数量",         "api_status":"连接状态",         "removable":"是否可以删除",       }]     }   }`
