文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimController::reinstall

## 接口：重装系统

接口地址：/admin/dcim/reinstall POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "confirm":"失败时可能会返回,true弹出确认框取消或者继续安装,继续安装把参数check_disk_size=0和其他原有参数重新发起重装即可",     }   }`
