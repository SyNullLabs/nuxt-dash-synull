文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimController::ikvm

## 接口：获取ikvm

接口地址：/admin/dcim/ikvm POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "name":"下载的文件名",     }   }`
