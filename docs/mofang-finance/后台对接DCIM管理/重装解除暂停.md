文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimController::unsuspendReload

## 接口：重装解除暂停

接口地址：/admin/dcim/unsuspend\_reinstall POST

重装解除暂停 -- huanghao

  

**重装解除暂停,重装有disk\_check时可以调用**
