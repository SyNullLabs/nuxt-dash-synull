文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\HostController::getCancel

## 接口：产品内页取消原因

接口地址：host/cancel GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "download_data":[{//基础数据       }]     }   }`
