文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMarketController::deleteActivityBanner

## 接口：删除活动banner

接口地址：/admin/config\_market/activity\_banner DELETE
