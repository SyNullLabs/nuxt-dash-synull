文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigMarketController::appManageIndexPost

## 接口：应用管理设置页面提交

接口地址：/admin/config\_market/app\_manage\_index\_post POST
