文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\CartController::proList

## 接口：购物车商品列表(拉取缓存)

接口地址：cart/prolist GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "fgs":[{//商品信息       }]     }   }`
