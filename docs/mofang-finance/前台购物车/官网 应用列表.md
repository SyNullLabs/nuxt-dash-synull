文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\CartController::indexAppHomeOrigin

## 接口：官网 应用列表

接口地址：/cart/index\_app GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".products":[{//此产品组下所有产品的信息       }]     }   }`
