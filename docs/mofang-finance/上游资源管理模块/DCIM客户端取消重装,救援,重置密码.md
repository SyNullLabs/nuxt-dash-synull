文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UpperReachesController::dcimClientCancelReinstall

## 接口：DCIM客户端取消重装,救援,重置密码

接口地址：/admin/upper/dcim\_client/cancel\_task post

DCIM客户端取消重装,救援,重置密码 -- xj

  

**接口说明:DCIM客户端取消重装,救援,重置密码**
