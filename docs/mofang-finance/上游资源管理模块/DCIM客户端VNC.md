文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UpperReachesController::dcimClientVnc

## 接口：DCIM客户端VNC

接口地址：/admin/upper/dcim\_client/vnc post
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//基础数据         "password":"密码",         "url":"VNC地址",       }]     }   }`
