文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UpperReachesController::index

## 接口：上游列表

接口地址：admin/upper/index get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//基础数据         "id":"id",         "name":"姓名",         "phone":"联系方式",         "bz":"备注",       }]     }   }`
