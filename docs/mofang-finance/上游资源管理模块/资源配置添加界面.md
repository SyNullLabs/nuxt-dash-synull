文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UpperReachesController::addUpperPage

## 接口：资源配置添加界面

接口地址：/admin/upper/addupperpage get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//基础数据         "id":"id",         "name":"上游姓名",         "phone":"手机",         "bz":"配置",       }]     }   }`
