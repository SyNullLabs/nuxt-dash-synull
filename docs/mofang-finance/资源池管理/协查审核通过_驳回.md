文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::putInspection

## 接口：协查审核通过/驳回

接口地址：/admin/resource/inspection PUT
