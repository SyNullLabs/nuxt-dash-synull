文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::getWithdraw

## 接口：提现记录

接口地址：/admin/resource/withdraw GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "logs":"提现记录=>禅道列表顺序显示",       "count":"数量",     }   }`
