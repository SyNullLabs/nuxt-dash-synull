文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::getAgentList

## 接口：代理商列表

接口地址：/admin/resource/agentlist GET
