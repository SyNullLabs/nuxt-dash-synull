文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::postChangeClients

## 接口：启用/停用用户

接口地址：/admin/resource/changeclients POST
