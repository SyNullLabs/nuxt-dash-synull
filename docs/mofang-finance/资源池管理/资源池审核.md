文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::postCheckRecords

## 接口：资源池审核

接口地址：/admin/resource/checkrecords POST
...
Active通过，Cancelled未通过，Wait合同待签订，Unpaid未付款
