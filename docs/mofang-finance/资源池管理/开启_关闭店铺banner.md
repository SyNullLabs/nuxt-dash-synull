文档地址：http://w2.test.idcsmart.com/doc?name=app\\res\\controller\\ResourceAdminController::putShopBanner

## 接口：开启/关闭店铺banner

接口地址：/admin/resource/shopbanner PUT
