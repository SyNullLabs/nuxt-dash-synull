文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\PublicController::adPage

## 接口：后台登录页面

接口地址：/admin/login\_page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "second_verify_admin：是否开启 后台验证":"",       "second_verify_action_admin":"是否有登录验证",     }   }`
