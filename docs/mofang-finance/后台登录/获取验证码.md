文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\PublicController::getVerifyCode

## 接口：获取验证码

接口地址：/admin/get\_verify\_code GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "captcha":" 验证码",     }   }`
