文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\PublicController::checkToken

## 接口：生成资源池jwt

接口地址：/admin/agent/checktoken GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "jwt":"",     }   }`
