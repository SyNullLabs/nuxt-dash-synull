文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CommonController::infoNotice

## 接口：系统后台消息通知

接口地址：/admin/common/info\_notice get

系统后台消息通知 -- wyh

  

**接口说明: 后台首页,前端定时调用此接口,info非空时,浏览器声音提醒**
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "info":"系统消息通知内容",     }   }`
