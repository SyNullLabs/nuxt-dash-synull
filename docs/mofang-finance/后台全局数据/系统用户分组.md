文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CommonController::getClientGroups

## 接口：系统用户分组

接口地址：/admin/common/get\_client\_groups get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "client_groups":"系统用户分组",     }   }`
