文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CommonController::getProductConfigOptions

## 接口：可配置项

接口地址：/admin/common/product\_config\_options get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "config_options":"可配置项",     }   }`
