文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CommonController::getEmailTem

## 接口：系统邮件模板列表

接口地址：/admin/common/get\_email\_tem get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "email":"系统邮件模板列表",     }   }`
