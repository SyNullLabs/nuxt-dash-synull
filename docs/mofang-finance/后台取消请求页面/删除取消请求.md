文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CancelRequestController::deleteList

## 接口：删除取消请求

接口地址：/admin/cancel\_request/list delete
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "id":"ID",     }   }`
