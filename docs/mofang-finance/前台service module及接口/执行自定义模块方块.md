文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\ProvisionController::customFunc

## 接口：执行自定义模块方块

接口地址：/provision/custom/:id POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "[type] [description]":"",     }   }`
