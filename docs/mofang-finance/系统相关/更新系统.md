文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SystemController::getAutoUpdate

## 接口：更新系统

接口地址： admin/system/autoupdate GET

更新系统 -- wyh

  

**更新系统:下载zip包，解压,执行sql语句,覆盖系统原文件**
