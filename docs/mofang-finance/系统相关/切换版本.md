文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SystemController::postToggleVersion

## 接口：切换版本

接口地址： admin/system/toggleversion POST

切换版本 -- wyh

  

**在正式版stable、测试版beta之间切换**
