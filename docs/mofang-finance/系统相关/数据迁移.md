文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SystemController::getDataMigrate

## 接口：数据迁移

接口地址： admin/system/datamigrate GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "last_version":"系统最新版本",     }   }`
