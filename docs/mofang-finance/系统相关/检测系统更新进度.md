文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SystemController::getCheckAutoUpdate

## 接口：检测系统更新进度

接口地址： admin/system/checkautoupdate GET

检测系统更新进度 -- wyh

  

**前端定时调用此接口,获取系统更新最新进度**
