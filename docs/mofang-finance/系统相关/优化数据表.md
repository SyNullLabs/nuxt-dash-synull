文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SystemController::postOptimizeTables

## 接口：优化数据表

接口地址： admin/system/optimizetables GET

优化数据表 -- 萧十一郎

  

**清除数据表空洞，OPTIMIZE TABLE**
