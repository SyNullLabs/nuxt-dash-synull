文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CurrencyController::updatePrice

## 接口：更新价格

接口地址：/admin/currency/update\_price GET

更新价格 -- wyh

  

**更新价格,所有涉及到价格的都要按当前汇率进行价格更新!**
