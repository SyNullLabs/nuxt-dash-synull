文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\CurrencyController::addCurrency

## 接口：添加货币种类

接口地址：/admin/currency/add\_currency POST
