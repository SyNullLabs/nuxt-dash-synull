文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AffiliateController::getTimetype

## 接口：获取时间类型

接口地址：/admin/aff/get\_timetype GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//基础数据(搜索区)       }]     }   }`
