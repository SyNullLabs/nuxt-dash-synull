文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AffiliateController::gatewaylist

## 接口：推介计划支付方式

接口地址：/admin/aff/gateway\_list get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "gateway":[{//支付方式       }]     }   }`
