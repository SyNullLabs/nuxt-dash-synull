文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UserManageController::requestCancelReasonPost

## 接口： 取消请求原因增加修改

接口地址：admin/request\_cancel\_reason\_post post
