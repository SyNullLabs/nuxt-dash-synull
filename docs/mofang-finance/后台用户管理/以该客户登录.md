文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UserManageController::loginByUser

## 接口： 以该客户登录

接口地址：admin/login\_by\_user/:uid get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//账单列表         "id":"账单ID",       }]     }   }`
