文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UserManageController::certifiPersonDownload

## 接口：客户个人认证图片下载

接口地址：/admin/certifi\_person\_download GET
...
图片类型：type=idfront(身份证正面照)或者type=idback(身份证反面)
