文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\VoucherController::getAreaList

## 接口：区域三级联动

接口地址：voucher/arealist GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "area":"区域",     }   }`
