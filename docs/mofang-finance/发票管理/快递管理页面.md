文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\VoucherController::getExpress

## 接口：快递管理页面

接口地址：admin/voucher/express GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "express":[{//快递详情         "name":"名称",         "price":"价格",       }]     }   }`
