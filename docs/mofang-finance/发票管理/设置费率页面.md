文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\VoucherController::getRate

## 接口：设置费率页面

接口地址：admin/voucher/rate GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "voucher_manager":"是否开启发票管理",       "rate":"费率",     }   }`
