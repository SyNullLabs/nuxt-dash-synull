文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\ContractController::contractList

## 接口：合同管理

接口地址：/contract/contract GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "lists":[{//合同列表       }]     }   }`
