文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\ContractController::download

## 接口：查看下载

接口地址：/contract/download/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".pdf_address":"合同地址",     }   }`
