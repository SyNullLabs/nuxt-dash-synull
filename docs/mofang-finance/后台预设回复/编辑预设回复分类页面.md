文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketPrereplyController::editCategoryPage

## 接口：编辑预设回复分类页面

接口地址： admin/save\_ticket\_prereply\_category/page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "category":"新增分类id",     }   }`
