文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketPrereplyController::deleteCategory

## 接口：删除预设回复分类

接口地址： admin/delete\_ticket\_prereply\_category/:id GET
