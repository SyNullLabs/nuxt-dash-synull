文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketPrereplyController::addPrereplyPage

## 接口：添加预设回复页面

接口地址： admin/add\_ticket\_prereply/page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".categories.id":"分类id",       ".categories.name":"分类名称",     }   }`
