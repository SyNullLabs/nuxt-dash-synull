文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketPrereplyController::searchPrereply

## 接口：搜索预设回复

接口地址： admin/search\_ticket\_prereply POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".id":"预设回复id",       ".title":"预设回复标题",       ".content":"预设回复内容",     }   }`
