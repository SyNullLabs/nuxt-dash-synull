文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketPrereplyController::addCategory

## 接口：添加预设回复分类

接口地址： admin/add\_ticket\_prereply\_category POST
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "":"新增分类id",     }   }`
