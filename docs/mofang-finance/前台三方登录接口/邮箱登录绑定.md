文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\OauthController::bindLoginEmail

## 接口：邮箱登录绑定

接口地址：/oauth/bind\_login\_email POST

邮箱登录绑定 -- xionglingyuan
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".oauthStatus":"'invalid,绑定信息失效的时候跳转到登录页',",     }   }`
