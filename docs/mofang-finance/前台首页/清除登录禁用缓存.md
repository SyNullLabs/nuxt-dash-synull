文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\IndexController::del\_cwxt\_home\_login

## 接口：清除登录禁用缓存

接口地址：del\_cwxt\_home\_login GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data":[{//销售列表       }]     }   }`
