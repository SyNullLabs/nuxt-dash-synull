文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketController::downloadAttachment

## 接口：下载附件

接口地址： admin/download\_ticket\_attachment GET
