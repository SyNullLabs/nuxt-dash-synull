文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AccountController::update

## 接口：更新流水表详情

接口地址：admin/accounts/:id put
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".data":"1or0",     }   }`
