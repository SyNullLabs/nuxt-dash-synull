文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AccountController::create

## 接口：获取新增必要数据

接口地址：/admin/accounts/create get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".users":"用户列表",       ".currency":"货币",       ".gateways":"网关",     }   }`
