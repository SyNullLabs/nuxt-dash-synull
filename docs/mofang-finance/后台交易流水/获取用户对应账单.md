文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AccountController::createInvoice

## 接口：获取用户对应账单

接口地址：/admin/accounts/createinvoice get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".invoice":"用户列表",     }   }`
