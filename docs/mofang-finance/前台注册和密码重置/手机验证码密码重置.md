文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\RegisterController::passPhoneReset

## 接口：手机验证码密码重置

接口地址：/reset\_phone POST

手机验证码密码重置 -- wyh

  

**接口说明:手机+验证码--密码重置(username,code,password)**
