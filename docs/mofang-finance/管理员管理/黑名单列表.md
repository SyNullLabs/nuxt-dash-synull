文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\UserController::getBlackList

## 接口：黑名单列表

接口地址：admin/user/get\_black\_list GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "list":[{//黑名单         "id":"idip:ipcreate_time:创建时间type:类型username:用户名",       }]     }   }`
