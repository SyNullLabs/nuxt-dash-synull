文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ContractController::download

## 接口：合同查看下载

接口地址：/admin/contract/download/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "pdf":"合同地址",     }   }`
