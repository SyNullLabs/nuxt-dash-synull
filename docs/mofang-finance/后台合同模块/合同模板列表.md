文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ContractController::tpl

## 接口：合同模板列表

接口地址：/admin/contract/tpl GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "contracts":[{//合同列表信息       }]     }   }`
