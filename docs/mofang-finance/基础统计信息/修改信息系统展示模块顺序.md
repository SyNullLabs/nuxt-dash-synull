文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ReportController::updateSystemInfoModulesSort

## 接口：修改信息系统展示模块顺序

接口地址：/admin/report/update\_base\_module post

修改信息系统展示模块顺序 -- 请设置auhtor注释

  

**参数二维数组，分别有字段：id，sort，enable**
