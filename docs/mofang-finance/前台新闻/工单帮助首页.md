文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\NewsController::getNotice

## 接口：工单帮助首页

接口地址：news/notice GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "id":"新闻分类id",       "title":"新闻分类标题",       "list":[{//帮助数据         "id":"文章id",         "title":"新闻分类标题",         "description":"描述",         "head_img":"封面图片",       }]     }   }`
