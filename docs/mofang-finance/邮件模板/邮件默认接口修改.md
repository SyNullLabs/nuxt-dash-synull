文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\EmailTemplateController::emailOperatorSwitch

## 接口：邮件默认接口修改

接口地址：/admin/email\_template/operator\_switch post
