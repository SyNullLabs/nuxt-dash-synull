文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\EmailTemplateController::manageLanguagesPost

## 接口：管理邮件模板语言页面提交

接口地址：/admin/email\_template/manage\_language\_post POST
