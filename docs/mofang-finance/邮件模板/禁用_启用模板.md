文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\EmailTemplateController::disabledTemplate

## 接口：禁用/启用模板

接口地址：/admin/email\_template/disabled\_template POST
