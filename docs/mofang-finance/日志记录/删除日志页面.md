文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\LogRecordController::getDeleteLogPage

## 接口：删除日志页面

接口地址：/admin/log\_record/delete\_log\_page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"总数",       "type":"类型",     }   }`
