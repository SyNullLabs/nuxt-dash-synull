文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\LogRecordController::getAffirmDeleteLogPage

## 接口：删除日志页面(二次确认)

接口地址：/admin/log\_record/affirm\_delete\_log\_page GET
