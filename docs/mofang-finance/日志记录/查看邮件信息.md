文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\LogRecordController::getEmailDetail

## 接口：查看邮件信息

接口地址：/admin/log\_record/emaildetail/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "detail":[{//日志数据         "username":"发送给to:邮件subject:主题message:信息",       }]     }   }`
