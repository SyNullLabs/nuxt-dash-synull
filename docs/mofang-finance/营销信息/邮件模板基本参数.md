文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SendMessageBatchController::editTemplate

## 接口：邮件模板基本参数

接口地址：/admin/edit\_template GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".base_args":"基础参数",       ".combine":"模板类型相关参数",     }   }`
