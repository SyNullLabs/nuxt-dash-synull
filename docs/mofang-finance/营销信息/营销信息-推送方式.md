文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SendMessageBatchController::getSendMethod

## 接口：营销信息-推送方式

接口地址：/admin/getSendMethod get

营销信息-推送方式 -- 请设置auhtor注释
