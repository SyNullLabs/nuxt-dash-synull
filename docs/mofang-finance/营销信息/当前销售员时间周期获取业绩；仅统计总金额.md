文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SendMessageBatchController::getLaddersaleStatisticsOnlyTotalAccount

## 接口：当前销售员时间周期获取业绩；仅统计总金额

接口地址：请设置url注释 GET

当前销售员时间周期获取业绩；仅统计总金额 -- 请设置auhtor注释
