文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\SendMessageBatchController::check

## 接口：检查当前用户是否为销售员 不可以查看sale\_id为空的

接口地址：请设置url注释 GET

检查当前用户是否为销售员 不可以查看sale\_id为空的 -- 刘国栋
