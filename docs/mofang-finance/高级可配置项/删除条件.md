文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AdvancedOptionsController::deleteCondition

## 接口：删除条件

接口地址：/admin/advanced\_options/deletecondition DELETE
