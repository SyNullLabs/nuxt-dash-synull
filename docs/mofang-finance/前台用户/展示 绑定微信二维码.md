文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\UserController::bind\_wechat

## 接口：展示 绑定微信二维码

接口地址：/bind\_wechat get
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "data 微信二维码地址":"",     }   }`
