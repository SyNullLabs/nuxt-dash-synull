文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\TicketDepartmentController::addPage

## 接口：添加新部门页面

接口地址： admin/get\_ticket\_department GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "id":"管理员id",       "user_login":"用户名",       "user_nickname":"姓名",     }   }`
