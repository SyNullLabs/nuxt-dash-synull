文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigOptionsController::configOptionsOs

## 接口：拉取系统自带接口操作系统并同步

接口地址：/admin/options/config\_options\_check\_os/:pid POST

拉取系统自带接口操作系统并同步 -- xiong
