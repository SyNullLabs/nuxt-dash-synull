文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigOptionsController::duplicateGroups

## 接口：复制可配置选项组页面

接口地址：/admin/options/duplicate\_groups GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       ".groups":"所有可选项配置组的信息",     }   }`
