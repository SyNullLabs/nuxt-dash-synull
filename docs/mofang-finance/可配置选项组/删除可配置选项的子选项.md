文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigOptionsController::deleteSubOptions

## 接口：删除可配置选项的子选项

接口地址：/admin/options/delete\_sub\_options/:subid GET
