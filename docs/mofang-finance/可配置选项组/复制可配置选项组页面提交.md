文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ConfigOptionsController::duplicateGroupsPost

## 接口：复制可配置选项组页面提交

接口地址：/admin/options/duplicate\_groups\_post POST
