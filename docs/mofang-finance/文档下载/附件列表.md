文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DownloadsController::getUserDownList

## 接口：附件列表

接口地址：admin/downloads/userdownlist GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "list":[{//附件数据       }]     }   }`
