文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DownloadsController::postUploadUserFile

## 接口：添加文件

接口地址：admin/downloads/uploaduserfile POST

添加文件 -- 萧十一郎

  

**接口说明:添加文件，上传或ftp上传后填写到这里**
