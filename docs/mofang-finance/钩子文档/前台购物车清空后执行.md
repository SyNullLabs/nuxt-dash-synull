文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\HooksController::shopping\_cart\_clear

## 接口：前台购物车清空后执行

接口地址：shopping\_cart\_clear GET
...
二维数组(pid=产品ID,billingcycle=购买周期,num=购买数量)
