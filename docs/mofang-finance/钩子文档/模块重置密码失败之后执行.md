文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\HooksController::after\_module\_crack\_password\_failed

## 接口：模块重置密码失败之后执行

接口地址：after\_module\_crack\_password\_failed GET
