文档地址：http://w2.test.idcsmart.com/doc?name=app\\home\\controller\\HooksController::after\_module\_hard\_reboot\_failed

## 接口：模块硬重启失败之后执行

接口地址：after\_module\_hard\_reboot\_failed GET
