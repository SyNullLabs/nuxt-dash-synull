文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::postDeveloperRewardDesignated

## 接口：悬赏指定开发者

接口地址：admin/developer/developerrewarddesignated POST
