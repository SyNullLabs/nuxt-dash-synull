文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::postDeveloperRewardPayment

## 接口：悬赏打款

接口地址：admin/developer/developerrewardpayment POST
