文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::getDevelopers

## 接口：获取所有开发者

接口地址：/admin/developer/developers GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"总数",       "developer":[{//开发者列表         "name":"昵称",       }]     }   }`
