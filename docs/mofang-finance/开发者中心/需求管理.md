文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::getDemand

## 接口：需求管理

接口地址：admin/developer/demand GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"数量",       "demand":[{//需求       }]     }   }`
