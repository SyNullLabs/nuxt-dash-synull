文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::postHiddenDeveloperReward

## 接口：显示/隐藏悬赏

接口地址：/admin/developer/hiddendeveloperreward POST
