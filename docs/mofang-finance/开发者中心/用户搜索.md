文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::getUserSearch

## 接口：用户搜索

接口地址：admin/developer/usersearch GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"总数",       "user":[{//用户         "id":"用户IDusername:名称",       }]     }   }`
