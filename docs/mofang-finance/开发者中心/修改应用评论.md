文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::putEdit\_app\_evaluation

## 接口：修改应用评论

接口地址：/admin/developer/edit\_app\_evaluation PUT
