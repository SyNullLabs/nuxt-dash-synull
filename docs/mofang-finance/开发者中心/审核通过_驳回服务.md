文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::postCheckDeveloperService

## 接口：审核通过/驳回服务

接口地址：/admin/developer/checkdeveloperservice POST
