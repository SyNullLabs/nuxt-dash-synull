文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::postServiceToggleRetired

## 接口：上/下架服务

接口地址：/admin/developer/servicetoggleretired POST
