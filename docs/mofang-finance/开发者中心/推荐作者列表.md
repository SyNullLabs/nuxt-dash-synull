文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DeveloperController::getRecommendlist

## 接口：推荐作者列表

接口地址：/admin/developer/recommendlist GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "count":"总数",       "developer":[{//作者信息       }]     }   }`
