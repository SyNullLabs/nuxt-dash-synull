文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ZjmfFinanceApiController::modifyApi

## 接口：修改魔方财务API

接口地址：/admin/zjmf\_finance\_api PUT
