文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AnnounceController::getList

## 接口：站点公告列表数据

接口地址：admin/announce/list GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "array|\think\Response":"",     }   }`
