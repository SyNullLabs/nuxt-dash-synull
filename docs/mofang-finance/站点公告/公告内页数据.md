文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\AnnounceController::getManage

## 接口：公告内页数据

接口地址：admin/announce/manage/:id GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "array|\think\Response":"",       "mulil_data":[{//多语言数据         "language":"语言标识",       }]     }   }`
