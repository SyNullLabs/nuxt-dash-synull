文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\DcimCloudController::refreshServerStatus

## 接口：获取服务器状态

接口地址：/admin/dcimcloud/server/:id/status GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "server_status":"服务器状态(1连接测试成功,0失败)",     }   }`
