文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ProductController::addPage

## 接口：产品添加页面

接口地址：/admin/add\_product\_page GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "groupdata":[{//产品组数据         "id":"组ID",         "name":"组名称",       }]       "type":"产品类型",     }   }`
