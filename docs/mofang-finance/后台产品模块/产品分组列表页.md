文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ProductController::groupList

## 接口：产品分组列表页

接口地址：/admin/product/productgroup GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "total":"列表总数",       "list":[{//列表表数据         "group_name":"分组名",         "pids":"产品组列表",       }]     }   }`
