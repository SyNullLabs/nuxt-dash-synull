文档地址：http://w2.test.idcsmart.com/doc?name=app\\admin\\controller\\ProductController::getUpstreamPrice

## 接口：获取上游产品成本价

接口地址：/admin/product/get\_upstream\_price GET
...
`{     "status":200/201/203/204/400/401/406,     "msg":提示信息,     "data":{       "flag":[{//折扣         "bates":"折扣type:1百分比、2固定金额",       }]     }   }`
